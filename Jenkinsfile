    ...
    stages {
        stage('Git checkout') {
            steps {
                ...
                git branch: 'main', url: 'https://github.com/rajaakeju/Northeast-fully-automated-infra.git'
                sh 'ls'
            }
        }
        ...
        stage('Checkov scan') {
            steps {
                ...
                #checkov -d .
                #checkov -d . --skip-check CKV_AWS_23,CKV_AWS_24,CKV_AWS_79,CKV_AWS_135,CKV_AWS_8,CKV_AWS_23,CKV_AWS_24,CKV_AWS_79
